...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "documentation_source/source/examples/The_GS_Standard/plot_help_I_have_no_variable_metadata.py", line 23, in <module>
        survey.add_tabular(type='csv', data_filename=d_data, metadata_file=d_supp)
      File "gspy/src/classes/survey/Survey.py", line 131, in add_tabular
        out = tabular_csv.Tabular_csv.read(data_filename, metadata_file=metadata_file, spatial_ref=self.spatial_ref, **kwargs)
      File "gspy/src/classes/data/Tabular.py", line 135, in read
        cls._create_variable_metadata_template(filename, file.df.columns)
      File "gspy/src/classes/data/tabular_csv.py", line 183, in _create_variable_metadata_template
        raise Exception(s)
    Exception: 
